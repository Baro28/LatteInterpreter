...
instance Print (AbsGramatyka.TopDef' a) where
  prt i = \case
    AbsGramatyka.FnDef _ funtype id_ args block -> prPrec i 0 (concatD [prt 0 funtype, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
...
instance Print (AbsGramatyka.Stmt' a) where
  prt i = \case
    ...
    AbsGramatyka.Cond _ expr block -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
    AbsGramatyka.CondElse _ expr block1 block2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block1, doc (showString "else"), prt 0 block2])
    AbsGramatyka.While _ expr block -> prPrec i 0 (concatD [doc (showString "while"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
    AbsGramatyka.SExp _ expr -> prPrec i 0 (concatD [prt 0 expr, doc (showString ";")])
    AbsGramatyka.Cont _ -> prPrec i 0 (concatD [doc (showString "continue"), doc (showString ";")])
    AbsGramatyka.Break _ -> prPrec i 0 (concatD [doc (showString "break"), doc (showString ";")])
    AbsGramatyka.Print _ expr -> prPrec i 0 (concatD [doc (showString "print"), prt 0 expr, doc (showString ";")])
...
instance Print (AbsGramatyka.Type' a) where
  prt i = \case
    ...
    AbsGramatyka.Bool _ -> prPrec i 0 (concatD [doc (showString "boolean")])
...
instance Print (AbsGramatyka.FunType' a) where
  prt i = \case
    AbsGramatyka.Void _ -> prPrec i 0 (concatD [doc (showString "void")])
    AbsGramatyka.RetType _ type_ -> prPrec i 0 (concatD [prt 0 type_])

instance Print (AbsGramatyka.ArgType' a) where
  prt i = \case
    AbsGramatyka.Ref _ type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "*")])
    AbsGramatyka.Value _ type_ -> prPrec i 0 (concatD [prt 0 type_])
...
instance Print (AbsGramatyka.Expr' a) where
  prt i = \case
    ...
    AbsGramatyka.EApp _ id_ passedargs -> prPrec i 6 (concatD [prt 0 id_, doc (showString "("), prt 0 passedargs, doc (showString ")")])
...
instance Print (AbsGramatyka.PassedArg' a) where
  prt i = \case
    AbsGramatyka.EVal _ expr -> prPrec i 0 (concatD [prt 0 expr])
    AbsGramatyka.ERef _ id_ -> prPrec i 0 (concatD [doc (showString "&"), prt 0 id_])
